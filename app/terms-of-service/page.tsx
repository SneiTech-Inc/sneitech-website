          ...
          <div className="prose prose-invert max-w-none space-y-12">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing or using the services provided by SneiTech Inc, you agree to be bound by these Terms of
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                (including Sporvex and SaveVex) are the exclusive property of SneiTech Inc. You may not reproduce, distribute, or
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                SneiTech Inc shall not be liable for any indirect, incidental, or consequential damages arising out of
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                These terms are governed by and construed in accordance with the laws of the jurisdiction in which SneiTech Inc 
