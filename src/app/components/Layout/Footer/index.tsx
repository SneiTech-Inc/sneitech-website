      ...
      <div className='container mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8'>
        <div className='grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8'>
          ...
          <div className='col-span-4'>
            <h4 className='text-white text-3xl leading-9 mb-1 lg:mb-20'>
              SneiTech Inc
            </h4>
            <p className='text-white lg:mb-20'>
              Sneitech Inc. transforms ideas into innovative digital products that empower people and businesses.
            </p>
