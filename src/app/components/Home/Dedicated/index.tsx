        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-5'>
          ...
          <div className='col-span-12 lg:col-span-6'>
            ...
            <p className='text-xl font-medium text-black/55 mt-5 text-center lg:text-start'>
              Sneitech Inc. was founded with a clear vision — to transform ambitious ideas into impactful digital products. 
              My goal is to lead with creativity, innovation, and purpose, while building solutions that inspire trust and deliver real results.
            </p>
