...
const Digital = () => {
  return (
    <section id='Digital' className='relative bg-cover bg-center overflow-hidden'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-2'>
            ...
            <div className='pt-24 lg:pl-24'>
              ...
              <h2 className='text-white mb-8 leading-tight text-center lg:text-start lg:w-full'>
                We create innovative digital products that empower businesses and connect people..
              </h2>
